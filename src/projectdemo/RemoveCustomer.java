...
public class RemoveCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter a customer Id you want t remove");
...
// 
        ...
        try {
           ...
           if(!mid.equals(""))
           {
               String query = "DELETE FROM CUSTOMER WHERE CustomerId="+mid;       
           ...
           if(!mname.equals(""))
           {
               String queryr = "DELETE FROM CUSTOMER WHERE CustomerName='"+mname+"'";       
           ...
           if(!maddress.equals(""))
           {
               String queryer = "DELETE FROM CUSTOMER WHERE CustomerAddress='"+maddress+"'";       
            PreparedStatement  pser;
            pser = connection.prepareStatement(queryer);
           pser.executeUpdate();
