    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection(
               ...
               if(!mid.equals(""))
        {
            String query = "DELETE FROM ORDERS WHERE OrderId="+mid;
            ...
            ps = connection.prepareStatement(query);
             ...
             if(!mqty.equals(""))
        {
            String queryqa = "DELETE FROM ORDERS WHERE Quantity="+mqty;
          ...
          if(!mPid.equals(""))
        {
            String queryqq = "DELETE FROM ORDERS WHERE ProductId="+mPid;
          ...
          if(!mdate.equals(""))
        {
            String queryqa = "DELETE FROM ORDERS WHERE OrderDate="+mdate;
