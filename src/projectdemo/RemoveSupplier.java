...
public class RemoveSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Supplier Name:");
        jPanel4.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, -1, -1));
        ...
        jPanel4.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, 170, -1));
        ...
        jPanel4.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, 170, -1));
      ...
      //  String mname = name.getText();
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection(
               ...
               if(!mid.equals(""))
        {
            String query = "DELETE FROM SUPPLIER WHERE SupplierId="+mid;
         ...
         if(!mname.equals(""))
           {
               String queryr = "DELETE FROM SUPPLIER WHERE SupplierName='"+mname+"'";       
